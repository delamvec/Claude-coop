...
//		Note : ĳ������ Lighting, Local Point Light, Weapon Trace ���� ȿ���� �޺� ����Ÿ, ���� ����Ÿ,
//             ��� ����Ÿ ���� �߻���, ��ü������ �����ϴ� ���� �Ŵ����� �� ���̴�.
...
{
public:
    void StartPositionBlend(
        const BlendingPosition& sBlending,
        DWORD dwDuration,
        DWORD dwServerTime);

    void UpdatePositionBlend(DWORD dwCurrentTime);
    bool IsPositionBlending() const;

	protected:
		bool  m_bPositionBlending;

		float m_fBlendStartX;
		float m_fBlendStartY;
		float m_fBlendDestX;
		float m_fBlendDestY;

		DWORD m_dwBlendStartTime;
		DWORD m_dwBlendDuration;
	public:
		DWORD GetBlendStartTime() const { return m_dwBlendStartTime; }  // ← opraveno
		DWORD GetBlendDuration() const { return m_dwBlendDuration; }    // ← opraveno
	...
	protected:
    std::map<DWORD, int> m_mapAttackSync;
	...
	protected:
		...
		void __HitGreate(CActorInstance& rVictim, unsigned int uiSkill, bool isEnemy);
	...
	private:
    	float __GetInvisibleTimeAdjust(UINT uiSkill, const NRaceData::TAttackData& c_rAttackData);
	...
	protected:
		void __OnHit(UINT uSkill, CActorInstance& rkInstVictm, BOOL isSendPacket, BlendingPosition* pBlending);
