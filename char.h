...
class CHARACTER : public CEntity, public CFSM, public CHorseRider
{
	...
	protected:
		...
		// [SYNC UPDATE]
		// ============================
		CStateTemplate<CHARACTER>	m_stateSyncing; //nove
	...
	public:
		...
		// ============================
		// [SYNC UPDATE – PUBLIC API]
		// ============================
		bool				BlendSync(long x, long y, unsigned int unDuration);

	protected:
		// ============================
		// [SYNC UPDATE – DATA]
		// ============================
		PIXEL_POSITION		m_posBlendStart;
		PIXEL_POSITION		m_posBlendDest;

		DWORD				m_dwSyncStartTime;
		DWORD				m_dwSyncDuration;
		//////////////////////////////////////////////////
...
//		bool			IsPet() const		{ return m_bCharType == CHAR_TYPE_PET; }
	...
	protected:
		...
		//////////////////////////////////////////////////////////////////////////////////
	public:
		bool 			IsStateMove() 				{ return IsState((CState&)m_stateMove); }
		bool 			IsStateIdle() 				{ return IsState((CState&)m_stateIdle); }
