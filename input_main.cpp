		...
		case HEADER_CG_ATTACK:
			{
				...
				const long TEMP_MAP_BASE_X = 921600; // TEMPORARY - from log analysis
				const long TEMP_MAP_BASE_Y = 204800; // TEMPORARY - from log analysis
					...
					packMelee->fSyncDestX != 0.0f && packMelee->fSyncDestY != 0.0f)
				{
					...
					// If coordinates don't match (allowing 10 pixel tolerance) = PACKET MANIPULATION!
				...
				pack.dwAttackerVID = dwAttackerVID;  // FIX: Correct field name (was dwAttacakerVID)
